      ...
      <div style={{ padding: '40px 16px', maxWidth: 1200, margin: '0 auto' }}>
        ...
        >
          <Title level={1} style={{ textAlign: 'center', marginBottom: 40 }}>
            Terms and Conditions for Nevlix Coffee Products
          </Title>
          
          <Card>
            <Title level={3}>1. Introduction</Title>
            <Paragraph>
              Welcome to Assktofit! By accessing or using our services, you agree to be bound by these terms and conditions. These terms outline the rules and regulations for using Nevlix's website, applications, and purchasing our coffee products.
            </Paragraph>
            ...
            <Paragraph>
              <strong>Quality Assurance:</strong> Nevlix guarantees that all coffee products meet high-quality standards. However, slight variations in taste and appearance may occur due to the nature of coffee beans.
            </Paragraph>
            <Paragraph>
